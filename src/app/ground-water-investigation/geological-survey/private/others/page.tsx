...
export default function GeologicalSurveyPrivateOthersPage() {
  ...
  const roles = [
    { id: 'hg', label: 'Hydrogeologist' },
    { id: 'jhg', label: 'Junior Hydrogeologist' },
    { id: 'ga', label: 'Geological Assistant' },
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between gap-4">
        <PageHeader title="Other Geological Surveys (Private)" />
        {showViewOnly && (
      ...
      <div className="flex justify-end pt-4">
        <Button size="lg" asChild disabled={!isAllowed} className="px-12 bg-[#00aeef] hover:bg-[#00aeef]/90 text-white font-bold uppercase tracking-widest gap-2 rounded-xl shadow-lg">
          <Link href={`/ground-water-investigation/geological-survey/private/others/site-entry?startDate=${workStartDate}&endDate=${workEndDate}`}>
            Next
