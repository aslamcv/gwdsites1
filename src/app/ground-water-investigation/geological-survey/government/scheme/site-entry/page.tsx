...
import { ArrowLeft, Save, ChevronDown, ClipboardList, Calendar } from 'lucide-react';
...
export default function GovernmentSchemeGeologicalSurveySiteEntryPage() {
  const { toast } = useToast();
  const searchParams = useSearchParams();
  const invDate = searchParams.get('date');
    ...
    <div className="p-4 sm:p-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/ground-water-investigation/geological-survey/private/domestic">
      ...
      <div className="mt-6 bg-primary/5 p-4 rounded-lg border border-primary/10 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm font-semibold">Date of Investigation: {invDate || 'Default'}</p>
        </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="mt-6 space-y-6">
          ...
          <Card> 
            <CardHeader><CardTitle>19. Hydrogeology & Geology of the area</CardTitle></CardHeader> 
            <CardContent> 
          ...
          <Card> 
            <CardHeader><CardTitle>20. Details of nearby groundwater structures</CardTitle></CardHeader> 
          ...
          <Card> 
            <CardHeader><CardTitle>21. Recommendation</CardTitle></CardHeader> 
              ...
              {selectedNearbyStructure?.startsWith('borewell') && !selectedNearbyStructure.includes('no_') && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      {...form.register(selectedNearbyStructure === 'borewell1' ? 'nearbyBorewell1Diameter' : selectedNearbyStructure === 'borewell2' ? 'nearbyBorewell1Diameter' : 'nearbyBorewell3Diameter')} 
                      className="bg-white border-cyan-100 h-12 focus:ring-[#00aeef]" 
              ...
              {selectedNearbyStructure?.startsWith('openwell') && !selectedNearbyStructure.includes('no_') && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      onValueChange={(val) => form.setValue(selectedNearbyStructure === 'openwell1' ? 'nearbyOpenwell1Type' : selectedNearbyStructure === 'openwell2' ? 'nearbyOpenwell2Type' : 'nearbyOpenwell3Type', val)}
