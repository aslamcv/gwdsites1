  ...
  const onSubmit = (values: ReportFormValues) => {
    ...
    startTransition(() => {
      ...
      const reportData = {
        ...
        purpose: "Ground Water Investigation / Geological Survey / Government / Others",
        dateOfInvestigation: dateOfInvestigation,
        category: "Geological Survey / Government / Others",
        uploadedBy: user.uid,
    ...
    <div className="p-4 sm:p-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/ground-water-investigation/geological-survey/government/others">
