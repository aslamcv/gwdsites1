...
export default function SiteEntryPage() {
  ...
  const hgName = searchParams.get('hg');
  const jhgName = searchParams.get('jhg');
  const gaName = searchParams.get('ga');
  ...
  const onSubmit = (values: ReportFormValues) => {
    ...
    startTransition(() => {
      ...
      const reportData = {
        ...
        purpose: "Ground Water Investigation / Geological Survey / Government / Institutional",
        dateOfInvestigation: dateOfInvestigation,
        category: "Geological Survey / Government / Institutional",
        uploadedBy: user.uid,
        createdAt: new Date().toISOString(),
        staffAssignment: {
          geologicalAssistant: gaName || "",
          juniorHydrogeologist: jhgName || "",
          hydrogeologist: hgName || ""
        }
      };
    ...
    <div className="p-4 sm:p-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/ground-water-investigation/geological-survey/government/institutional">
