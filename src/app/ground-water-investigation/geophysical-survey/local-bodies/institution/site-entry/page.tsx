...
export default function LocalBodiesInstitutionalGeophysicalSurveySiteEntryPage() {
  ...
  const onSubmit = (values: ReportFormValues) => {
    ...
    startTransition(() => {
      ...
      const reportData = {
        ...
        purpose: "Ground Water Investigation / Geophysical Survey / Local Bodies / Institution",
        dateOfInvestigation: dateOfInvestigation,
        category: "Geophysical Survey / Local Bodies / Institution",
        uploadedBy: user.uid,
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" asChild>
            <Link href="/ground-water-investigation/geophysical-survey/local-bodies/institution">
        ...
        <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden border-none shadow-2xl">
          <div className="bg-[#e0fbfc] p-6 space-y-6">
                ...
                <>
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input {...form.register('recBorewellTotalDepth')} className="bg-white border-cyan-100 h-12 focus:ring-[#00aeef]" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-sm font-semibold text-slate-700">Recommended diameter</Label>
                      <Select onValueChange={(val) => form.setValue('recBorewellDiameter', val)} value={form.getValues('recBorewellDiameter')}>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input {...form.register('expectedOverburden')} className="bg-white border-cyan-100 h-12 focus:ring-[#00aeef]" />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-sm font-semibold text-slate-700">Additional Borewell Details & Location</Label>
                    <Textarea {...form.register('recommendationBorewell')} rows={4} className="bg-white border-cyan-100 focus:ring-[#00aeef] resize-none" />
                  </div>
                </>
              )}
              ...
              {form.getValues('recommendationType') === 'openwell' && (
                <>
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-sm font-semibold text-slate-700">Recommended total depth (m)</Label>
                      <Input {...form.register('recOpenwellTotalDepth')} className="bg-white border-cyan-100 h-12 focus:ring-[#00aeef]" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-sm font-semibold text-slate-700">Recommended diameter</Label>
                      <Select onValueChange={(val) => form.setValue('recOpenwellDiameter', val)} value={form.getValues('recOpenwellDiameter')}>
                        <SelectTrigger className="bg-white border-cyan-100 h-12">
                          <SelectValue placeholder="Select diameter" />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea {...form.register('recommendationOpenwell')} rows={4} className="bg-white border-cyan-100 focus:ring-[#00aeef] resize-none" />
                  </div>
                </>
              )}
            </div>
            ...
            <DialogFooter className="bg-white/50 p-4 -mx-6 -mb-6 border-t border-cyan-100">
              <Button type="button" onClick={() => setIsRecommendationDialogOpen(false)} className="bg-[#00aeef] hover:bg-[#00aeef]/90 w-full h-12 font-bold uppercase tracking-widest shadow-lg text-white">
