...
export default function GovernmentIndustrialGeophysicalSurveySiteEntryPage() {
  ...
  const onSubmit = (values: ReportFormValues) => {
    ...
    startTransition(() => {
      ...
      const reportData = {
        ...
        purpose: "Ground Water Investigation / Geophysical Survey / Government / Industrial",
        dateOfInvestigation: dateOfInvestigation,
        category: "Geophysical Survey / Government / Industrial",
        uploadedBy: user.uid,
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" asChild>
            <Link href="/ground-water-investigation/geophysical-survey/government/industrial">
