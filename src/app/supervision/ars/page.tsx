...
export default function ARSSupervisionPage() {
  return (
    <div className="p-4 sm:p-6 space-y-8 min-h-screen bg-slate-50/50">
      <PageHeader title="Supervision( ARS Supervision )" />
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mt-6">
        {/* ARS DUG WELL RECHARGE Card */}
        <Card className="group hover:border-primary/50 transition-all border-2 shadow-sm bg-white overflow-hidden relative">
          ...
          <CardHeader className="pb-4 pt-8">
            ...
            <CardTitle className="text-2xl font-black uppercase tracking-tight text-slate-800">ARS DUG WELL RECHARGE</CardTitle>
            <CardDescription className="text-sm font-medium leading-relaxed">
              Supervision of Artificial Recharge Structures through dug well recharge projects.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-4 pb-8">
            <Button asChild className="w-full h-14 font-black uppercase tracking-widest gap-3 bg-[#1e3a8a] hover:bg-[#1e3a8a]/90 shadow-lg shadow-blue-900/20 rounded-xl">
              <Link href="/supervision/ars/dugwell-entry">
                ARS DUG WELL SUPERVISION
        ...
        <Card className="group hover:border-[#00aeef]/50 transition-all border-2 shadow-sm bg-white overflow-hidden relative">
          ...
          <CardHeader className="pb-4 pt-8">
            ...
            <CardTitle className="text-2xl font-black uppercase tracking-tight text-slate-800">ARS PIT RECHARGE</CardTitle>
            <CardDescription className="text-sm font-medium leading-relaxed">
              Supervision of Artificial Recharge Structures through pit recharge projects.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-4 pb-8">
            <Button variant="outline" asChild className="w-full h-14 font-black uppercase tracking-widest gap-3 border-[#00aeef]/30 text-[#1e3a8a] bg-[#e0fbfc]/20 hover:bg-[#e0fbfc]/40 rounded-xl">
              <Link href="/supervision/ars/pit/inspection">
                ARS PIT SUPERVISION
                <ArrowRight className="h-5 w-5" />
              </Link>
            </Button>
