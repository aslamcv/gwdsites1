...
export default function PumpingTestPrivateIndustrialPage() {
  return (
    <div className="p-4 sm:p-6 space-y-8">
      <div className="flex items-center gap-4">
        ...
        <PageHeader title="Industrial Pumping Test (Private)" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
        <Card className="group hover:border-primary/50 transition-all border-2 shadow-sm bg-white">
          <CardHeader className="pb-4">
            ...
            <CardDescription>Manage technical yield data for high-capacity industrial open wells.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild className="w-full h-11 font-bold uppercase tracking-widest gap-2 bg-blue-600 hover:bg-blue-700">
              <Link href="/pumping-test/private/industrial/open-well">
        ...
        <Card className="group hover:border-emerald-500/50 transition-all border-2 shadow-sm bg-white">
          <CardHeader className="pb-4">
            ...
            <CardDescription>Record rigorous step drawdown tests for industrial groundwater permits.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button variant="outline" asChild className="w-full h-11 font-bold uppercase tracking-widest gap-2 border-emerald-200 text-emerald-700 hover:bg-emerald-50">
              <Link href="/pumping-test/private/industrial/bore-well">
                START PUMPING TEST ENTRY
                <ArrowRight className="h-4 w-4" />
              </Link>
            </Button>
