...
export default function BoreWellPumpingTestPage() {
  ...
  const defaultValues: FormValues = useMemo(() => ({
    nameOfSite: '', address: '', lsgd: '', district: 'Malappuram', nameOfObserver: '', pumpCapacity: '', measuringPointHt: '', lattitude: '', longitude: '', date: new Date().toISOString().split('T')[0], remarks: '', recommendation: '', step1: defaultStepData, step2: defaultStepData, step3: defaultStepData, turbidity: defaultTurbidityData, summary: defaultSummaryData, recoveryData: defaultRecoveryData,
  }), []);
  ...
  const onSubmit = (values: FormValues) => {
    ...
    startTransition(() => {
      ...
      const reportData = {
        ...
        purpose: "Pumping Test / Private / Infrastructure / Bore Well",
        category: "Pumping Test / Private / Infrastructure / Bore Well",
        uploadedBy: user.uid,
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              <div className="space-y-4">
                ...
                <FormField control={form.control} name="lsgd" render={({ field }) => ( <FormItem><FormLabel>LSGD</FormLabel><FormControl><Input placeholder="LSGD" {...field} /></FormControl><FormMessage /></FormItem> )} />
