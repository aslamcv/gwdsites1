...
export default function GovernmentLocalBodiesWellPage() {
  return (
    <div className="p-4 sm:p-6 space-y-8">
      <PageHeader title="Local Bodies Well Operations (Government)" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
        <Card className="group hover:border-primary/50 transition-all border-2 shadow-sm">
          <CardHeader className="pb-4">
            ...
            <CardTitle className="text-2xl font-black uppercase tracking-tight">Recent Local Body Well Drilling</CardTitle>
            <CardDescription>Record new construction details for Local Body projects.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild className="w-full h-12 font-bold uppercase tracking-widest gap-2">
              <Link href="/well-drilling/government/local-bodies/drilling-entry">
        ...
        <Card className="group hover:border-accent/50 transition-all border-2 shadow-sm">
          <CardHeader className="pb-4">
            ...
            <CardTitle className="text-2xl font-black uppercase tracking-tight">Recent Local Body Well Flushing</CardTitle>
            <CardDescription>Log well cleaning and maintenance for Local Body schemes.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button variant="outline" asChild className="w-full h-12 font-bold uppercase tracking-widest gap-2 border-accent/20 text-primary hover:bg-accent/5">
              <Link href="/well-drilling/government/local-bodies/flushing-entry">
