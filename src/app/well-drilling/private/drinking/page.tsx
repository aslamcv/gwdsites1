...
export default function PrivateDrinkingWellPage() {
  return (
    <div className="p-4 sm:p-6 space-y-8">
      <PageHeader title="Private Drinking Well Operations" />
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
        {/* 1) Recent Drinking Well Drilling */}
        <Card className="group hover:border-primary/50 transition-all border-2 shadow-sm">
          <CardHeader className="pb-4">
            ...
            <CardTitle className="text-2xl font-black uppercase tracking-tight">Recent Drinking well Drilling</CardTitle>
          ...
          <CardContent>
            <Button asChild className="w-full h-12 font-bold uppercase tracking-widest gap-2">
              <Link href="/well-drilling/private/drinking/drilling-entry">
        ...
        {/* 2) Recent Drinking Well Flushing */}
        <Card className="group hover:border-accent/50 transition-all border-2 shadow-sm">
          <CardHeader className="pb-4">
            ...
            <CardTitle className="text-2xl font-black uppercase tracking-tight">Recent Drinking well Flushing</CardTitle>
          ...
          <CardContent>
            <Button variant="outline" asChild className="w-full h-12 font-bold uppercase tracking-widest gap-2 border-accent/20 text-primary hover:bg-accent/5">
              <Link href="/well-drilling/private/drinking/flushing-entry">
