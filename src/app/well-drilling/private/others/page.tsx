...
export default function PrivateOtherWellPage() {
  return (
    <div className="p-4 sm:p-6 space-y-8">
      <PageHeader title="Private Other Well Operations" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
        <Card className="group hover:border-primary/50 transition-all border-2 shadow-sm">
          <CardHeader className="pb-4">
            ...
            <CardDescription>Record construction details for non-standard private wells.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild className="w-full h-12 font-bold uppercase tracking-widest gap-2">
              <Link href="/well-drilling/private/others/drilling-entry">
        ...
        <Card className="group hover:border-accent/50 transition-all border-2 shadow-sm">
          <CardHeader className="pb-4">
            ...
            <CardDescription>Log cleaning and development for non-standard structures.</CardDescription>
          </CardHeader>
          <CardContent>
            <Button variant="outline" asChild className="w-full h-12 font-bold uppercase tracking-widest gap-2 border-accent/20 text-primary hover:bg-accent/5">
              <Link href="/well-drilling/private/others/flushing-entry">
