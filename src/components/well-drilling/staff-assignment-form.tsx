...
export function StaffAssignmentForm({ title, backUrl, nextUrl }: StaffAssignmentFormProps) {
  ...
  const staffConfigs = [
    { 
      ...
      max: 2, 
      icon: UserCheck,
      designations: ['Master Driller', 'Senior Driller', 'Driller', 'Driller Mechanic'] 
    },
    { 
      key: 'siteSupervisor', 
    ...
    { 
      ...
      max: 5, 
      icon: Settings,
      designations: ['Driller', 'Driller Mechanic'] 
    },
    { 
      key: 'drillingAssistants', 
      label: 'DRILLING ASSISTANT(S)', 
      max: 7, 
      icon: Construction,
      designations: ['Drilling Assistant'] 
    },
    { 
      key: 'drivers', 
      label: 'DRIVERS', 
  ...
  const handleContinue = () => {
    ...
    startTransition(() => {
      ...
      const reportData = {
        ...
        purpose: title.includes('Drilling') ? 'Well Drilling' : 'Well Flushing',
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-12">
      ...
      <div className="flex justify-end pt-4 pb-12">
        ...
        >
          {!isAllowed && <Lock className="size-4 mr-2" />}
          {isPending ? <Loader2 className="animate-spin size-5" /> : null}
          {isAllowed ? 'Continue to Technical Entry' : 'Access Restricted'}
